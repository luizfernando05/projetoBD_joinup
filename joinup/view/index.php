...
<body>
    ...
    <div class="container">
        ...
        <div class="cards-oportunidades">
            ...
            $query = "
            SELECT o.nomeOportunidade, e.nomeEmpresa, t.tipo, o.cidade, o.estado, r.requisito, o.dataInicio, o.dataFim, e.setorEmpresa, e.emailEmpresa, e.telefoneEmpresa
            ...
            INNER JOIN sistema.requisitoOportunidade AS r ON o.idOportunidade = r.idOportunidade;
            ";
            ...
            try {
                ...
                while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    $requisitos = explode(', ', $row['requisito']);
                    foreach ($requisitos as $requisito) {
                        echo '<span class="font-2-xs color-c12">' . $requisito . '</span>';
                    }
                    echo '</div>';
